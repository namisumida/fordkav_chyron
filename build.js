...
d3.csv("Data/KavanaughFord_longdata.csv", rowConverter, function(data) {
	...
	screen4.append("text")
				 ...
				 .attr("x", (w_svg-600)/2)
				 .attr("y", 12)
				 .text("Let's break up the chyrons into those that appeared during Ford's hearing and those that appeared during Kavanaugh's\
				 				hearing.")
				 .call(wrap, 600);
	screen4.append("text")
				 .attr("class", "intro_text")
				 .attr("id", "intro4_2")
				 .text("During Ford’s hearing, MSNBC changed their chyrons the most and Fox News the least. But that could be a function of the total number of chyrons shown\
				 (since we've already seen that MSNBC showed more chyrons overall compared to the other two networks).")
				 .attr("x", (w_svg-600)/2)
				 .attr("y", 75)
				 .call(wrap, 600);
	...
	screen5.append("text")
				 ...
				 .attr("x", (w_svg-650)/2)
				 .attr("y", 12)
				 .text("But when we look at the proportion of chyrons displayed during Ford’s hearing out of all chyrons shown,\
				  we find that at least half of MSNBC’s and CNN’s chyrons occurred during Ford’s hearing,\
	 				compared with a third of Fox News’ chyrons - meaning Fox News was less likely to give varied reports of Ford’s hearing.")
				 .call(wrap, 650);
	screen5.append("text")
				 .attr("class", "intro_text")
				 .attr("id", "intro5_2")
				 .text("Scroll over each square to read the chyron that was displayed.")
				 .attr("x", (w_svg-650)/2)
				 .attr("y", 110)
				 .call(wrap, 650);
	...
	screen7.append("text")
				 ...
				 .attr("x", (w_svg-600)/2)
				 .attr("y", 20)
				 .text("About a third of chyrons by MSNBC and CNN occurred during Kavanaugh's hearing, compared with 62% of Fox News' chyrons.")
				 .call(wrap, 600);
	screen7.append("text")
				 .attr("class", "intro_text")
				 .attr("id", "intro7_2")
